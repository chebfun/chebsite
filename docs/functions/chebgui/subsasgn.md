...
<html>
   <head>
      ...
      <title>MATLAB File Help: chebgui/subsasgn</title>
   </head>
   <body>
      <!--Single-page help-->
      <table border="0" cellspacing="0" width="100%">
         <tr class="subheader">
            <td class="headertitle">MATLAB File Help: chebgui/subsasgn</td>
            <td class="subheader-left"><a href="matlab:edit chebgui/subsasgn">View code for chebgui/subsasgn</a></td>
