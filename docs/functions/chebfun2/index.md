...
function_snippets: 
    ...
    - "Display information about a CHEBFUN2."
    ...
    - "Minimum value of a CHEBFUN in one direction."
    - "Global maximum of a CHEBFUN2."
    ...
    - "Display the PLOTCOEFFS of the column and row slices."
    - "Display bivariate coefficients graphically."
