...
function_snippets: 
    ...
    - "Circular convolution of a Fourier-based CHEBFUNs."
    ...
    - "Display information about a CHEBFUN."
    ...
    - "Fourier coefficients of a CHEBFUN."
    ...
    - "Happiness state of a CHEBFUN object."
    ...
    - "Display coefficients graphically."
    - "CHEBFUN plus."
